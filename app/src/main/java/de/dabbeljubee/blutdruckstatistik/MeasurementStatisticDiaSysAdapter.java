...
public class MeasurementStatisticDiaSysAdapter extends MeasurementStatisticAdapter {
    ...
    protected void fillRowWithData(TableRow row, MeasurementStatisticItem item) {
        ...
        ((TextView) row.findViewById(R.id.statistic_over_low)).setText(item.getDiastolic().getAlarmRatio().toPlainString());
        ((TextView) row.findViewById(R.id.statistic_under_low)).setText(item.getDiastolic().getWarningRatio().toPlainString());
    }
}
