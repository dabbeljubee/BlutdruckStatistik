...
public class MeasurementStatisticSystolicAdapter extends MeasurementStatisticAdapter {
    ...
    protected void formatHeader(View rootView) {
        ...
        level1.setText(rootView.getResources().getString(
                R.string.statistics_header_level_less, DataProvider.sysLevels.getAlarm()));
        ...
        level2.setText(rootView.getResources().getString(
                R.string.statistics_header_level_less, DataProvider.sysLevels.getWarning()));
        ...
        level3.setText(rootView.getResources().getString(
                R.string.statistics_header_level_less, DataProvider.sysLevels.getLow()));
        ...
        level4.setText(rootView.getResources().getString(
                R.string.statistics_header_level_greater, DataProvider.sysLevels.getLow()));
    }

    @Override
    protected void fillRowWithData(TableRow row, MeasurementStatisticItem item) {
        ((TextView) row.findViewById(R.id.statistic_over_alarm)).setText(item.getSystolic().getAlarmRatio().toPlainString());
        ((TextView) row.findViewById(R.id.statistic_over_warning)).setText(item.getSystolic().getWarningRatio().toPlainString());
        ((TextView) row.findViewById(R.id.statistic_over_low)).setText(item.getSystolic().getNormalRatio().toPlainString());
        ((TextView) row.findViewById(R.id.statistic_under_low)).setText(item.getSystolic().getLowRatio().toPlainString());
    }
}
